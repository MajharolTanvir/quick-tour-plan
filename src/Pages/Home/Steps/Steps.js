...
const Steps = () => {
  return (
    <section className="my-10">
      <div>
        <div className="text-3xl text-center font-bold text-primary">STEPS</div>
          ...
          <div className="flex flex-wrap w-full">
            <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
              <div className="flex relative pb-12">
                ...
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-accent inline-flex items-center justify-center text-black relative z-10">
                  <svg
                    fill="none"
                    stroke="currentColor"
                    strokeLinecap="round"
