        ...
        <section className="text-gray-100 body-font relative">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center justify-center w-full mb-12">
                    <div className='text-3xl text-center font-bold text-teal-400'>CONTACT</div>
                ...
                <div className="lg:w-1/2 md:w-2/3 mx-auto">
                    <div className="flex flex-wrap -m-2">
                        ...
                        <div className="p-2 w-full">
                            <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg w-full justify-center">Button</button>
                        </div>
                    </div>
                </div>
            </div>
