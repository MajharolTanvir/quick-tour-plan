    ...
    <section className="my-10">
      <div>
        ...
        <div className="flex justify-center">
          ...
          <div className="w-8 h-1 bg-primary rounded-lg mr-1"></div>
          <div className="w-5 h-1 bg-primary rounded-lg mr-1"></div>
        </div>
      </div>
      <div className="text-accent body-font">
          ...
          <div className="flex flex-wrap -m-4 text-center">
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                ...
                <h2 className="title-font font-medium text-3xl text-accent">
                  2.7K
                </h2>
